...
// Set the colors for the rows
	if (i%2 == 1) { bgcolor_true = '#d9f2d9'; fontcolor_true = '#000'; bgcolor_false = '#FFF'; fontcolor_false = '#000'; }
	else          { bgcolor_true = '#d9f2d9'; fontcolor_true = '#000'; bgcolor_false = '#FFF'; fontcolor_false = '#000'; }
...
<?php				if ($net2ftp_settings["functionuse_findstring"]     == "yes") { ?><input type="button" id="smallbutton" value="<?php echo __("Search"); ?>"         onclick="submitBrowseForm('<?php echo $directory_js; ?>', '', 'findstring', '');"           title="<?php echo __("Find files which contain a particular word"); ?> (accesskey f)" accesskey="f" /> <?php } // end if ?>
	...
	<tr class="browse_rows_heading">
		<td style="width: 32px;"><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="CheckAll(document.BrowseForm);"  title="Click to check or uncheck all rows" accesskey="t"><?php echo __("All"); ?></a></td>
		<td colspan="1"><a style=""></td>
		<td colspan="1"><a style=""><?php echo $sortArray["dirfilename"]["text"];?></a></td>
		<td colspan="1"><a style="padding-left: 10px"><?php echo $sortArray["type"]["text"];?></a></td>
		<td colspan="1"><a style=""><?php echo $sortArray["size"]["text"];?></a></td>
		<td colspan="1"><a style=""><?php echo $sortArray["owner"]["text"];?></a></td>
		<td colspan="1"><a style=""><?php echo $sortArray["group"]["text"];?></a></td>
		<td colspan="1"><a style=""><?php echo $sortArray["permissions"]["text"];?></a></td>
		<td colspan="1"><a style=""><?php echo $sortArray["mtime"]["text"];?></a></td>
		<td colspan="3"></td>
	</tr>
...
<?php /* ----- Up ----- */ ?>
<?php  if ($directory_tree !== 'root /') { ?>
		<tr class="browse_rows_even" onmouseover="this.style.color='#000'; this.style.backgroundColor='#d9f2d9';" onmouseout="this.style.color='#000000'; this.style.backgroundColor='#F2F2F5';">
			<td></td>
...
// -------------------------- ?>
			<tr class="browse_rows_<?php echo $odd_even; ?>" id="row<?php echo $rowcounter; ?>" onmouseover="this.style.color='#000'; this.style.backgroundColor='#d9f2d9';" onmouseout="this.style.color='#000000'; setColor_js(<?php echo $rowcounter; ?>, '<?php echo $checkbox_hidden; ?>');">
...
<?php /* ----- Statistics ----- */ ?>
<div style="font-size: 90%; margin-top: 10px; margin-left: 50px;">
