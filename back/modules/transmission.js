...
module.exports = function() {
	...
	module.addMagnet = function(magnetLink, dir, callback) {
	...
	module.getInfo = function(client) {
		try {
	...
	module.pause = function(client, id){
	...
	module.resume = function(client, id){
	...
	module.delete = function(client, id, remove_data){
